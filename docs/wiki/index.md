...
- [Nous Research](entities/nous_research.md) - AI research org, Hermes Agent
- [midudev](entities/midudev.md) - Developer, Autoskills
- [Alex Newman](entities/thedotmack.md) - Creator of Claude-Mem
- [Multica AI](entities/multica_ai.md) - Agent platform company
- [OpenDataLoader Project](entities/opendataloader_project.md) - PDF extraction
- [Strix AI](entities/strix_ai.md) - AI security testing
- [AgentScope Team](entities/agentscope_team.md) - Multi-agent platform
- [Run Llama](entities/run_llama.md) - LlamaIndex org, LiteParse
- [Aiming Lab](entities/aiming_lab.md) - Research automation
...
- [LiteParse](sources/liteparse.md) - PDF parsing

### Builder_agents
- [Strix](sources/strix.md) - Security testing
...
- [Hermes Agent](sources/hermes_agent.md) - Self-improving agent
...
## Notes
Project wiki đang trong quá trình rebuild sau khi bị xóa. Tham khảo CLAUDE.md và mkdocs.yml để biết thêm chi tiết.