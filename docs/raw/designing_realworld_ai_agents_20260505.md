...
**YouTube Workshop**: https://www.youtube.com/watch?v=mYSRn6PC1mc  
**Slides**: https://drive.google.com/file/d/1RWdS5VQYjz7a9y7NzHhAnyhGtxi6e0vt/view  
**Course**: https://academy.towardsai.net/courses/agent-engineering
...
Watch the [2-hour YouTube workshop](https://www.youtube.com/watch?v=mYSRn6PC1mc) and slides. You'll come away with a mental model of the full multi-agent system: tool-use agents, evaluator-optimizer loops, grounded search, structured LLM output, and MCP-server design.
...
|---|---|
| [Agentic AI Engineering Course](https://academy.towardsai.net/courses/agent-engineering) | 34 lessons, 3 end-to-end portfolio projects, certificate, Discord community |
